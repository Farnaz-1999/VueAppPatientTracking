import { CreateIconProps, CreateLayerProps, CreateMapPointsOptions, CreateMarkers, CreateMarkersPoints, CreateRawStyleProps, CreateStyleProps, MarkersIconCallback, Ol, Style } from "../components/Map.model";
 ...
 * @returns ol layer
 */
export declare const createLayer: ({ target, style, source, }: CreateLayerProps) => Ol.layer.Vector;
/**
 ...
 */
export declare const createMapPoints: (items: PrimarySearchItem[], options?: CreateMapPointsOptions | undefined) => Promise<{
