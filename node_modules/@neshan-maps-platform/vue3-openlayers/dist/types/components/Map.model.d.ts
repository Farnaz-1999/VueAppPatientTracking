...
import { PrimaryReverseResult, SearchItem } from "../store/markers/markers.model";
...
export declare interface HandleSearchProps {
    term: string;
    coords?: [longitude: number, lattitude: number];
}
...
export declare type MarkersIconCallback = (point: CreateMarkersPointsItem) => CreateIconProps;
declare type EventsEmits<T extends keyof EmitData> = (event: T, arg: EmitData[T]) => void;
