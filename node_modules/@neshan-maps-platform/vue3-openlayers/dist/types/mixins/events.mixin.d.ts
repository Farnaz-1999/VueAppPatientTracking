...
export declare function eventsMixin({ emits, store, markerHoverCallback, zoomOnMarkerClick, zoomOnResultClick, popupOnMarkerHover, popupOnResultHover, reverseOnClick, markersIconCallback }: EventsMixinProps): {
    setupMapEvents: () => void;
