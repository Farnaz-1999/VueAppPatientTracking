export declare const actions: {
    markers: {
        ...
        selectFeauture: (context: import("./store.model").Context, feature: import("./markers/markers.model").SearchItem | import("./markers/markers.model").ReverseResult | import("openlayers").Feature, options?: import("./markers/markers.model").SelectFeautureOptions | undefined) => void;
        ...
        reverseOnPoint: (context: import("./store.model").Context, coords: import("openlayers").Coordinate, { useMarker, usePopup, customText, markersIconCallback, }?: import("./markers/markers.model").ReverseOnPointOptions) => Promise<{
        ...
        search: (context: import("./store.model").Context, { term, coords }: import("./markers/markers.model").SearchProps, options?: import("./markers/markers.model").SearchOptions | undefined) => Promise<{
    ...
    overlays: {
        ...
        createOverlay: (context: import("./store.model").Context, container: HTMLDivElement, persistent?: boolean) => import("openlayers").Overlay;
