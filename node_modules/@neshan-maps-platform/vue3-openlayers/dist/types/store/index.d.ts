import { ActionsModuleMapper, Context, RemoveFirstFromTuple } from "./store.model";
export declare const functionChanger: <T extends (...args: any) => ReturnType<T>>(func: T, context: Context) => (...args: RemoveFirstFromTuple<Parameters<T>>) => ReturnType<T>;
export declare const storeGen: () => {
    state: {
        api: {
    ...
    actions: ActionsModuleMapper<{
        markers: {
            addMarkers: import("./markers/markers.model").AddMarkers;
            toggleClusterSource: (context: Context, layer: import("openlayers").layer.Vector, deactivate: boolean) => void;
            getClusterByCoords: import("./markers/markers.model").GetClusterByCoords;
            getMarkerInClusterByCoords: (context: Context, cluster: import("openlayers").Feature, coords: import("openlayers").Coordinate) => import("openlayers").Feature | undefined;
            ...
            zoomToLayer: (context: Context, layer: import("openlayers").layer.Vector, options?: import("./markers/markers.model").ZoomToExtentOptions | undefined) => void;
            zoomToExtent: ({ state, getters }: Context, extent: import("openlayers").Extent, options?: import("./markers/markers.model").ZoomToExtentOptions | undefined) => void;
            zoomToCoords: (context: Context, coords: import("openlayers").Coordinate, options?: import("./markers/markers.model").ZoomToExtentOptions | undefined) => void;
            zoomToMarker: (context: Context, marker: import("openlayers").Feature, options?: import("./markers/markers.model").ZoomToExtentOptions | undefined) => void;
            zoomToCluster: (context: Context, cluster: import("openlayers").Feature, options?: import("./markers/markers.model").ZoomToExtentOptions | undefined) => void;
            selectFeauture: (context: Context, feature: import("./markers/markers.model").SearchItem | import("./markers/markers.model").ReverseResult | import("openlayers").Feature, options?: import("./markers/markers.model").SelectFeautureOptions | undefined) => void;
            deselectAll: (context: Context) => void;
            getFeatureFromEvent: (context: Context, evt: import("openlayers").MapBrowserEvent) => import("openlayers").Feature | undefined;
            reverseOnPoint: (context: Context, coords: import("openlayers").Coordinate, { useMarker, usePopup, customText, markersIconCallback, }?: import("./markers/markers.model").ReverseOnPointOptions) => Promise<{
            ...
            search: (context: Context, { term, coords }: import("./markers/markers.model").SearchProps, options?: import("./markers/markers.model").SearchOptions | undefined) => Promise<{
                markers: import("openlayers").layer.Vector;
                data: import("./markers/markers.model").SearchResult;
            } | undefined>;
        };
        dimensions: {
        ...
        overlays: {
            ...
            createOverlay: (context: Context, container: HTMLDivElement, persistent?: boolean) => import("openlayers").Overlay;
        ...
        map: {
            ...
            setMapType: (context: Context, value: import("./map/map.model").MapType) => void;
        };
    }>;
};
