...
import { AddMarkers, GetClusterByCoords, GetMarkerByCoords, GetSearchResultByFeature, ReverseOnPointOptions, ReverseResult, SearchItem, SearchOptions, SearchProps, SelectFeautureOptions, ZoomToExtentOptions } from "./markers.model";
...
export declare const markersActions: {
    ...
    reverseOnPoint: (context: Context, coords: Coordinate, { useMarker, usePopup, customText, markersIconCallback, }?: ReverseOnPointOptions) => Promise<{
    ...
    search: (context: Context, { term, coords }: SearchProps, options?: SearchOptions | undefined) => Promise<{
        markers: import("openlayers").layer.Vector;
        data: import("./markers.model").SearchResult;
    } | undefined>;
};
